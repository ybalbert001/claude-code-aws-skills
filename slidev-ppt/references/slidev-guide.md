...
5. **Use AWS dark theme by default** (`theme: ../themes/aws-dark`) for all presentations
...
- **DO use AWS dark theme** (`theme: ../themes/aws-dark`) by default for all presentations
...
- **Headmatter**: Use AWS dark theme (`theme: ../themes/aws-dark`), title, transitions (see ppt-aws-theme-demo)
...
- **Use AWS dark theme** (`theme: ../themes/aws-dark`) in headmatter
...
1. **Theme**: Always use `theme: ../themes/aws-dark` in headmatter (relative path to theme directory)
...
- Always use AWS dark theme (`theme: ../themes/aws-dark`) for all presentations - this is a relative path to the theme directory
